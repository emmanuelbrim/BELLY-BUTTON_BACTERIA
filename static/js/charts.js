...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var sampleArray = (samples.filter(sampleObj => sampleObj.id == sample))[0];
    ...
    var metaData = data.metadata;
    var resultData = metaData.filter(sampleObj => sampleObj.id == sample)[0];
    var wFreqData = resultData.wfreq;
